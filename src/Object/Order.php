...
class Order extends AbstractObject
{
	...
	/**
	 * @return string Номер накладной в системе курьерской службы
	 */ 
	...
	/**
	 * @return string Номер накладной в подсистеме срочной доставки курьерской службы
	 */ 
	...
	/**
	 * @return string Внутренний код заказа в системе
	 */ 
	...
	/**
	 * @return string Штрих-код заказа
	 */ 
	...
	/**
	 * @return float Общий вес заказа в килограммах
	 */ 
	...
	/**
	 * @return float Общий вес возврата заказа в килограммах
	 */ 
	...
	/**
	 * @return string Тип оплаты заказа получателем
	 */ 
	...
	/**
	 * @return string Тип корреспонденции
	 */ 
	...
	/**
	 * @return string Тип возвратной корреспонденции
	 */ 
	...
	/**
	 * @return string Время ожидания курьера
	 */ 
	...
	/**
	 * @return float Объявленная ценность
	 */ 
	...
	/**
	 * @return string Поручение - Примечание
	 */ 
	...
	/**
	 * @return bool Признак оплаты стоимости доставки получателем
	 */ 
	...
	/**
	 * @return string Код внутреннего статуса курьерской службы
	 */ 
	...
	/**
	 * @return string Код статуса клиента
	 */ 
	...
	/**
	 * @return string Данные о вручении, либо причина недоставки
	 */ 
	...
	/**
	 * @return string Код заказа во внешней системе
	 */ 
