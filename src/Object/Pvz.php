...
class Pvz extends AbstractObject
{
    ...
    /** @return string|null Код ПВЗ в системе */
    ...
    /** @return string|null Код ПВЗ используемый компанией-подрядчиком */
    ...
    /** @return string|null Код родительского элемента */
    public function getParentCode(): ?string
    {
        return $this->parentCode;
    }

    /** @return string|null Наименование родительского элемента */
    public function getParentName(): ?string
    {
        return $this->parentName;
    }

    /** @return Town|null Населенный пункт */
    ...
    /** @return string|null Телефоны ПВЗ */
    public function getPhone(): ?string
    {
        return $this->phone;
    }

    /** @return string|null Дополнительная информация */
    public function getComment(): ?string
    {
        return $this->comment;
    }

    /** @return string|null Режим работы */
    public function getWorkTime(): ?string
    {
        return $this->workTime;
    }

    /** @return string|null Описание местонахождения ПВЗ или пути к нему */
    public function getTravelDescription(): ?string
    {
        return $this->travelDescription;
    }

    /** @return float|null Максимальный вес, с которым работает ПВЗ */
    public function getMaxWeight(): ?float
    {
        return $this->maxWeight;
    }

    /** @return bool|null Признак приема наличных */
    public function getAcceptCash(): ?bool
    {
        return $this->acceptCash;
    }

    /** @return bool|null Признак приема банковских карт */
    public function getAcceptCard(): ?bool
    {
        return $this->acceptCard;
    }

    /** @return bool|null Наличие примерки */
    public function getAcceptFitting(): ?bool
    {
        return $this->acceptFitting;
    }

    /** @return bool|null Признак доступности физическим лицам */
